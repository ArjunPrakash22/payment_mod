...
const PaymentHistory = () => {
    ...
    useEffect(() => {
        const fetchPaymentHistory = async () => {
            try {
                const response = await axios.post('http://localhost:5003/api/payment-history');
        ...
        <div className="payment-history-container">
            <div className="admin-panel">
                ...
                <div className="button-container">
                    ...
                    <button className="history-button" onClick={() => navigate('/payment-requests')}>
                        Payment Requests
                    </button> {/* Button to navigate to payment requests */}
                </div>
                        ...
                        <table className="table">
                            ...
                            <tbody>
                                {paymentHistory.length ? (
                                    ...
                                    <tr>
                                        <td colSpan="11" className="no-data">No payment history available</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
