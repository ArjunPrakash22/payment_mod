...
const CollegeFeesPage = () => {
  ...
  const [amountToPay, setAmountToPay] = useState(student.collegeFees);

  useEffect(() => {
  setAmountToPay(student.collegeFees);
    }, [paymentType, student.collegeFees]);
  ...
  return (
    <div className="payment-container">
      ...
      <div className="student-details">
        ...
        <p><strong>Total Amount:</strong> ₹{student.collegeFees}</p>
      </div>
